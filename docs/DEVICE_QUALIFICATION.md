...
| M2 Max / `apple,j416c`, `apple,t6021` | Inventory plus bounded in-tree userspace smoke; kernel `7.1.13-3-1-ARCH`, package `linux-asahi 7.1.13.asahi3-1`, installed VA driver `1.3-1` unused; selected library `27da69dd5fcb438deab970061a2edcc68a9e1d93`; [inventory](evidence/issue18/m2-j416c-inventory.json), [smoke](evidence/issue18/t6021-in-tree-smoke/README.md) | Experimental; three bit-exact hardware smokes (HEVC `AMP_A_Samsung_7` 17/17, AVC `AUD_MW_E` 100/100, VP9 `vp90-2-00-quantizer-00.webm` 2/2) on the loaded in-tree module; not a full-suite or patched-kernel qualification; `vainfo` still missing; loaded-binary identity unknown |
